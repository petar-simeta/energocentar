                ...
                <nav className="flex flex-1 flex-col gap-1">
                  ...
                  <div>
                    <button
                      ...
                      className="flex w-full items-center justify-between rounded-md px-3 py-3 font-display text-lg font-bold text-foreground transition-colors hover:bg-muted"
                  ...
                  {navigation.map((item) => (
                    <Link
                      ...
                      href={item.href}
                      onClick={() => setMobileMenuOpen(false)}
                      className="rounded-md px-3 py-3 font-display text-lg font-bold text-foreground transition-colors hover:bg-muted"
                    >
                      {item.name}
                    </Link>
                  ))}

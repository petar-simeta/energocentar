    ...
    <section id="proces" className="bg-primary py-20 sm:py-28">
      <div className="mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h2 className="font-display text-3xl font-bold text-primary-foreground sm:text-4xl">Proces izrade</h2>
          ...
          {steps.map((step, index) => {
            ...
            <div key={step.title} className="relative">
              ...
              <div className="relative flex flex-col items-center text-center">
                ...
                <h3 className="mt-2 font-display text-lg font-semibold text-primary-foreground">{step.title}</h3>

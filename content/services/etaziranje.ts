export const etaziranje = {
  ...
  hero: {
    ...
    description:
      "Stručna izrada elaborata etažiranja za upis posebnih dijelova nekretnine u zemljišne knjige. Rješavamo kompleksne slučajeve i vodimo vas kroz cijeli postupak do uspješnog upisa.",
  ...
  deliverables: {
    title: "Što dobivate?",
    description:
      "Izrađujemo kompletan elaborat etažiranja spreman za predaju zemljišnoknjižnom sudu, uključujući sve potrebne tehničke crteže i dokumentaciju.",
    items: [

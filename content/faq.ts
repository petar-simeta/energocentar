...
export const faqGroups: FaqGroup[] = [
  {
    ...
    faqs: [
      ...
      {
        question: "Treba li energetski certifikat za iznajmljivanje stana?",
        answer:
          "Da. Energetski certifikat je obavezan i pri iznajmljivanju stana, kuće ili poslovnog prostora, bez obzira radi li se o dugoročnom ili kratkoročnom najmu.",
      },
      {
        question: "Kolika je cijena energetskog certifikata?",
        answer:
          "Cijena energetskog certifikata ovisi o vrsti i veličini nekretnine. Za stan do 50 m² cijena je od 80 €. Točna cijena formira se prema površini i složenosti objekta.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Potrebni su osnovni podaci o nekretnini (adresa, površina, godina gradnje) te pristup svim prostorijama. Građevinska dokumentacija je korisna, ali nije obavezna.",
      },
      {
...

  {
    ...
    faqs: [
      ...
      {
        question: "Je li procjena nekretnine prihvatljiva za banku?",
        answer:
          "Da. Procjene izrađene od ovlaštenih procjenitelja prihvatljive su za sve banke i kreditne institucije u Hrvatskoj.",
      },
      {
      ...
      {
        question: "Utječe li lokacija na procijenjenu vrijednost?",
        answer:
      ...
      {
        question: "Može li se procjena koristiti na sudu?",
        answer:
    ...
    faqs: [
      {
        ...
        answer:
          "Etažiranje je postupak kojim se posebni dijelovi zgrade (stanovi, poslovni prostori) upisuju kao samostalne vlasničke cjeline u zemljišne knjige.",
      },
      {
        question: "Kada je potrebno etažiranje?",
        answer:
          "Etažiranje je potrebno kod prodaje, kupnje ili nasljeđivanja stana u zgradi koja još nije etažirana.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Za etažiranje je potrebna suglasnost suvlasnika koji imaju više od 50 % suvlasničkih udjela u zgradi.",
      },
      {
      ...
      {
        question: "Kolika je cijena etažiranja?",
        answer:
      ...
      },
      {
        ...
        answer:
          "Etažiranje nije obavezno, ali je nužno ako želite pojedinačno raspolagati stanovima ili poslovnim prostorima unutar zgrade.",
      },
    ],
  },
];

        ...
        <section className="border-b border-border bg-background py-16 sm:py-24">
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <h1 className="mt-6 font-serif text-4xl font-bold text-foreground sm:text-5xl">Uvjeti korištenja</h1>
        ...
        <section className="py-16 sm:py-24">
          <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
            <div className="prose prose-lg prose-gray max-w-none">
              <h2 className="font-serif text-2xl font-bold text-foreground">O tvrtki</h2>
              ...
              <h2 className="mt-12 font-serif text-2xl font-bold text-foreground">Korištenje web stranice</h2>
              <p className="text-muted-foreground">
              ...
              <h3 className="mt-8 font-serif text-xl font-semibold text-foreground">Dopušteno korištenje</h3>
              ...
              <h3 className="mt-8 font-serif text-xl font-semibold text-foreground">Zabranjeno korištenje</h3>
              <ul className="list-disc space-y-2 pl-6 text-muted-foreground">
              ...
              <h2 className="mt-12 font-serif text-2xl font-bold text-foreground">Naše usluge</h2>

              <h3 className="mt-8 font-serif text-xl font-semibold text-foreground">Energetski certifikati</h3>
              <p className="text-muted-foreground">
              ...
              <h3 className="mt-8 font-serif text-xl font-semibold text-foreground">Procjena nekretnina</h3>
              <p className="text-muted-foreground">
                Procjene izrađuju ovlašteni procjenitelji u skladu s propisima o procjeni vrijednosti nekretnina.
              </p>

              <h3 className="mt-8 font-serif text-xl font-semibold text-foreground">Etažiranje</h3>
              <p className="text-muted-foreground">
                Postupak etažiranja provodimo u skladu sa Zakonom o vlasništvu i drugim stvarnim pravima.
              </p>

              <h2 className="mt-12 font-serif text-2xl font-bold text-foreground">Cijene i plaćanje</h2>
              <ul className="list-disc space-y-2 pl-6 text-muted-foreground">
              ...
              <h2 className="mt-12 font-serif text-2xl font-bold text-foreground">Odgovornost</h2>
              <p className="text-muted-foreground">
              ...
              <h2 className="mt-12 font-serif text-2xl font-bold text-foreground">Intelektualno vlasništvo</h2>
              <p className="text-muted-foreground">
              ...
              <h2 className="mt-12 font-serif text-2xl font-bold text-foreground">Izmjene uvjeta</h2>
              <p className="text-muted-foreground">
              ...
              <h2 className="mt-12 font-serif text-2xl font-bold text-foreground">Primjenjivo pravo</h2>
              <p className="text-muted-foreground">

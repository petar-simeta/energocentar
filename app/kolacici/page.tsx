        ...
        <section className="border-b border-border bg-background py-16 sm:py-24">
          <div className="mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <h1 className="mt-6 font-display text-4xl font-bold text-foreground sm:text-5xl">Politika kolačića</h1>
        ...
        <section className="py-16 sm:py-24">
          <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
            <div className="prose prose-lg prose-gray max-w-none">
              ...
              <h2 className="mt-12 font-display text-2xl font-bold text-foreground">Tehnologije koje koristimo</h2>
              ...
              <h2 className="mt-12 font-display text-2xl font-bold text-foreground">Vaš izbor</h2>
              <p className="text-muted-foreground">
              ...
              <h2 className="mt-12 font-display text-2xl font-bold text-foreground">Upravljanje kolačićima</h2>
              <p className="text-muted-foreground">
              ...
              <h2 className="mt-12 font-display text-2xl font-bold text-foreground">Isključivanje kolačića</h2>
              <p className="text-muted-foreground">
